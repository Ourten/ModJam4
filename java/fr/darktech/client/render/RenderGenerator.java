...
public class RenderGenerator extends TileEntitySpecialRenderer implements IInventoryRenderer
{
	...
	public void renderGenerator(TileEntityGenerator generator, double x, double y, double z)
	{
		...
		if(generator.isStartDeploy() && !generator.generatorStates.get(1).isFinished())
			generator.MODEL_GENERATOR.renderWalls(generator.generatorStates.get(1).getPercent());
		else
			generator.MODEL_GENERATOR.renderWalls();
		
		if(generator.isStartDeploy() && !generator.generatorStates.get(2).isFinished())
		...
		if(generator.isStartDeploy() && !generator.generatorStates.get(3).isFinished())
		...
		if(generator.isStartDeploy() && !generator.generatorStates.get(0).isFinished())
		...
		if(generator.isStartDeploy() && !generator.generatorStates.get(6).isFinished())
		{
			if(revertedLight)
